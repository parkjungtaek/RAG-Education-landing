              ...
              >
                ...
                <Card className="relative h-full bg-gradient-to-br from-slate-900/90 via-blue-950/60 to-slate-900/90 backdrop-blur-md border-2 border-cyan-500/30 hover:border-cyan-400/60 transition-all duration-500 overflow-hidden">
                  ...
                  {index === 0 ? (
                    ...
                    // Third card - Course details with 2-column layout
                    <div className="flex flex-col lg:flex-row h-full p-4 gap-6">
                      ...
                      <div className="flex-1 flex flex-col justify-center">
                        <div className="grid grid-cols-1 gap-2.5 text-sm">
                          <motion.div
                            className="flex items-start gap-3 p-2.5 rounded-lg bg-slate-800/40 border border-cyan-500/20"
                            initial={{ opacity: 0, x: 20 }}
                            whileInView={{ opacity: 1, x: 0 }}
                            viewport={{ once: true }}
                            transition={{ delay: 0.2 }}
                          >
                            <div className="text-cyan-400 font-bold min-w-[80px] text-xs">교육 기간</div>
                            <div className="text-gray-300 text-xs">25년 12월 8일 ~ 26년 6월 4일 (960시간)</div>
                          </motion.div>
                          ...
                          >
                            <div className="text-cyan-400 font-bold min-w-[80px] text-xs">수업시간</div>
                            <div className="text-gray-300 text-xs">09:30 ~ 18:30 (월 ~ 금)</div>
                          </motion.div>
                          ...
                          >
                            <div className="text-cyan-400 font-bold min-w-[80px] text-xs">인원</div>
                            <div className="text-gray-300 text-xs">20명</div>
                          </motion.div>
                          ...
                          >
                            <div className="text-cyan-400 font-bold min-w-[80px] text-xs">장소</div>
                            <div className="text-gray-300 text-xs">에듀윌 국비교육원 구로센터 (구로디지털단지역)</div>
                          </motion.div>
                          ...
                          >
                            <div className="text-cyan-400 font-bold min-w-[80px] text-xs">대상</div>
                            <div className="text-gray-300 text-xs">미취업자 및 AI 기업 취업 희망자</div>
                          </motion.div>
                          ...
                          >
                            <div className="text-cyan-400 font-bold min-w-[80px] text-xs">혜택</div>
                            <div className="text-gray-300 text-xs">교육 및 교재 전액지원, 훈련비 지급</div>
                          </motion.div>

                          <motion.div
                            className="flex items-start gap-3 p-2.5 rounded-lg bg-gradient-to-r from-red-900/30 to-red-800/20 border-2 border-red-500/40"
                            initial={{ opacity: 0, x: 20 }}
                            whileInView={{ opacity: 1, x: 0 }}
                            viewport={{ once: true }}
                            transition={{ delay: 0.8 }}
                          >
                            <div className="text-red-400 font-bold min-w-[80px] text-xs">지원 마감일</div>
                            <div className="text-red-400 font-bold text-xs">11월 20일</div>
                          </motion.div>
                        </div>
                      </div>
                    </div>
