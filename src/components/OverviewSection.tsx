                        ...
                        <div className="relative w-full max-w-2xl">
                          ...
                          <div className="flex items-center justify-between gap-2">
                            ...
                            <motion.div
                              ...
                              transition={{ duration: 0.6, delay: 0.2 }}
                            >
                              <div className="w-20 h-20 bg-gradient-to-br from-gray-700/50 to-gray-800/50 rounded-xl border-2 border-gray-500/50 flex items-center justify-center relative group hover:border-cyan-400/60 transition-all">
                                <motion.div
                                  className="absolute inset-0 bg-cyan-500/10 rounded-xl opacity-0 group-hover:opacity-100 transition-opacity"
                              ...
                              <span className="text-xs text-gray-400 font-medium text-center leading-tight">데이터 입력문서<br/>PDF/매뉴얼</span>
                            </motion.div>
                            ...
                            >
                              <svg className="w-8 h-6 text-cyan-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 8l4 4m0 0l-4 4m4-4H3" />
                              </svg>
                            </motion.div>
                            ...
                            >
                              ...
                              <span className="text-xs text-gray-400 font-medium text-center leading-tight">음성 데이터→<br/>텍스트 변환</span>
                            </motion.div>
                            ...
                            <motion.div
                              ...
                              transition={{ duration: 0.6, delay: 0.4 }}
                            >
                              <div className="w-20 h-20 bg-gradient-to-br from-blue-600/30 to-blue-700/30 rounded-xl border-2 border-blue-500/50 flex items-center justify-center relative group hover:border-cyan-400/60 transition-all">
                                <motion.div
                                  className="absolute inset-0 bg-cyan-500/20 rounded-xl"
                                  animate={{
                                    scale: [1, 1.1, 1],
                              ...
                              <span className="text-xs text-gray-400 font-medium text-center leading-tight">색인 및 저장<br/>임베딩/벡터DB</span>
                            </motion.div>
                            ...
                            >
                              <div className="w-20 h-20 bg-gradient-to-br from-gray-700/50 to-gray-800/50 rounded-xl border-2 border-gray-500/50 flex items-center justify-center relative group hover:border-cyan-400/60 transition-all">
                                ...
                                <div className="relative z-10">
                                  ...
                                  <motion.div
                                    className="absolute -top-1 -right-1 w-5 h-5 bg-cyan-500/40 rounded-full border-2 border-cyan-400/60 flex items-center justify-center"
                                    animate={{ scale: [1, 1.2, 1] }}
                                    transition={{ duration: 2, repeat: Infinity }}
                                  >
                                    <span className="text-[8px] text-cyan-300 font-bold">?</span>
                                  </motion.div>
                                </div>
                              </div>
                              <span className="text-xs text-gray-400 font-medium text-center leading-tight">검색 및 순위<br/>Reranking</span>
                            </motion.div>
                            ...
                            >
                              ...
                              <span className="text-xs text-gray-400 font-medium text-center leading-tight">답변 생성<br/>Q&A/챗봇 카드</span>
                            </motion.div>
                            ...
                            >
                              ...
                              <span className="text-xs text-gray-400 font-medium text-center leading-tight">프로덕션<br/>모니터링<br/>대시보드</span>
                            </motion.div>
                          </div>
                        </div>
                      </div>
